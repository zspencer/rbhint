...
The file https://github.com/zspencer/rbhint/blob/master/config/default.yml[config/default.yml] under the RbHint home directory contains the
...
https://github.com/zspencer/rbhint/blob/master/config/default.yml[RbHint's defaults]. In the following example, we want to include
...
https://github.com/zspencer/rbhint/blob/master/CHANGELOG.md#0560-2018-05-14[0.56.0]
via https://github.com/zspencer/rbhint/pull/5882[#5882]. This change allows
...
in https://github.com/zspencer/rbhint/blob/master/config/default.yml[config/default.yml],
